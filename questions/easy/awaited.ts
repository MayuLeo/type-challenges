...
type MyAwaited<T extends PromiseLike<any | PromiseLike<any>>> =
  T extends PromiseLike<infer V>
    ...
    : never
/*
MyAwaited<T extends PromiseLike<any | PromiseLike<any>>>
  TはPromiseLike<any | PromiseLike<any>>な型に限定される

T extends PromiseLike<infer V>
  TがPromiseLikeな型を持つかどうか。この時の中の値がinferを使うことでVに推論された型が入る

V extends PromiseLike<any>
  VがさらにPromiseLikeかどうか
  PromiseLikeな型であれば再帰的に繰り返す
  そうでなければVを返す
*/
